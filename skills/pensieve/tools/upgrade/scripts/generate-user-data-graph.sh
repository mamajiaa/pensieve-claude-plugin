...
# Skip auto-generated graph files (legacy standalone and current embedded).
...
# Skip auto-generated SKILL files.
...
END {
    ...
    print ""
    print "> This file is auto-generated by a script; no manual maintenance needed."
    print ""
    print "- Root: `" root "`"
    ...
    #   A --based_on--> B and B --leads_to--> A: keep only "based_on".
    for (i = 1; i <= edge_unique_count; i++) {
        keep_edge[i] = 1
        if (edge_unique_lbl[i] == "leads_to") {
            reverse_based_key = edge_unique_tgt[i] SUBSEP "based_on" SUBSEP edge_unique_src[i]
