...
**Pipeline 负责流程编排，不承载信息聚合。**  
所有背景信息应沉淀到别处，并在 pipeline 中**引用**：

- **Knowledge**：外部资料、清单、最佳实践
- **Maxims**：普适原则与价值观
- **Decisions**：情境相关的选择与理由
- **外部 skills/tools**：重型指令或专用流程
...
| 核心原则 | 1-3 条简短可操作规则 |
| 不做信息堆叠 | 背景说明放到 Knowledge/Maxims/Decisions/Skills |
...
2. 使用知识中的清单进行检查（不要在 pipeline 里重复理论）
